...
class Config:
    ...
    NODE_COMPLETE_PII=os.getenv('NODE_COMPLETE_PII')
    NODE_COMPLETE_HALLUSINATION=os.getenv('NODE_COMPLETE_HALLUSINATION')
    NODE_COMPLETE_JAILBREAK=os.getenv('NODE_COMPLETE_JAILBREAK')
