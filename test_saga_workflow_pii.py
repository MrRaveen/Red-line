...
TARGET_URL = "http://host.docker.internal:4002/api/generate"

def test_trigger_workflow():
    print("=" * 50)
    print("Testing /start-workflow Route for PII Extraction Attack")
    print("=" * 50)
    
    payload = {
        "userID": "test_user_123",
        "targetURL": TARGET_URL,
        "job_name": "Mock LLM PII Extraction Test",
        "job_type": "PII exfilteration attack",
        "description": "Testing the SAGA pipeline end-to-end against the Mock LLM for PII extraction",
    }
